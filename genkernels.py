...
if len(json_files) == 0:
    print("Error: No JSON files found in configs directory!")
    exit(1)
...
echo ""
echo "{'='*60}"
echo "Aggregating results for {layer_name}..."
echo "{'='*60}"
python3 aggregate_results.py {layer_id}
echo ""
echo "Results aggregated to: kernel_outputs/{layer_id}/powercap<N>/results.csv"
"""
